...
export const MARK_NEXT_ITEM = 'MARK_NEXT_ITEM';
export const MARK_PREVIOUS_ITEM = 'MARK_PREVIOUS_ITEM';
...
export function markNextItem(){
	return {
		type: MARK_NEXT_ITEM
	}
}

export function markPreviousItem(){
	return {
		type: MARK_PREVIOUS_ITEM
	}
}
