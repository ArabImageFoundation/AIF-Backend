...
function requestDirectory(path='/',columnId) {
	return {
...
function requestFile(path,columnId) {
	return {
		type: REQUEST_FILE
	,	path
	,	columnId
...
function requestFileContents(path,columnId) {
	return {
...
function invalidateFile(path,columnId){
	return {
...
function invalidateDirectory(path='/',columnId){
	return {
...
function receiveFile(path,json,columnId) {
	return {
		type: RECEIVE_FILE
	,	path
	,	columnId
...
function receiveFileContents(path,contents,columnId) {
	return {
...
function receiveDirectory(path='/',json,columnId) {
	return {
...
function errorFetching(path,err,columnId){
	return {
		type: ERROR_FETCHING
	,	path
	,	error:err
